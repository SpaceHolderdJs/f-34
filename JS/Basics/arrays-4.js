...
const firstTask = data.find((user) => user.balance === 100);
console.log(firstTask, "firstTask");

const secondTask = data.every((user) => user.purchases > 1);
console.log(secondTask, "secondTask");

const thirdTask = data.filter(
  (user) => user.balance > 100 && user.purchases > 2
);
